...
const Footer = () => {
  return (
    <Box>
      ...
      >
        <Box sx={{ display: "flex" }} className="px-36">
          <Box sx={{ display: "flex", alignItems: "center" }}>
            <ImageList src="/img/8.webp" />
            <Box sx={{ paddingLeft: "60px", paddingRight: "10px" }}>
              <TypoTitle>رتبه یک سفر</TypoTitle>
              <TypoP>معتبرترین عرضه‌کننده محصولات گردشگری در ایران</TypoP>
            </Box>
          </Box>
          <Box sx={{ display: "flex", alignItems: "center" }}>
            <ImageList src="/img/9.webp" />
            <Box sx={{ paddingLeft: "60px", paddingRight: "10px" }}>
              <TypoTitle>همسفر هر سفر</TypoTitle>
              <TypoP>
          ...
          <Box sx={{ display: "flex", alignItems: "center" }}>
            <ImageList src="/img/10.webp" />
            <Box sx={{ paddingLeft: "60px", paddingRight: "10px" }}>
              <TypoTitle>همسفر همه لحظات سفر</TypoTitle>
              <TypoP>پشتیبانی و همراهی ۲۴ ساعته در تمامی مراحل سفر</TypoP>
            </Box>
          </Box>
        </Box>
        <Box className="px-36">
          ...
          >
            ...
            >
              ...
              <TypoP className="my-3 text-black text-lg">
                تلفن پشتیبانی: ۰۲۱ - ۴۳۹۰۰۰۰۰
              </TypoP>
              <TypoP className=" text-black text-lg">
              ...
              >
                <ImageList
                  className="w-[10%] cursor-pointer p-1 rounded-md mr-2  border border-[rgba(0,0,0,0.12)]"
                  src="https://cdn.alibaba.ir/h2/desktop/assets/images/footer/ecunion-35c3c933.jpg"
                ></ImageList>
                <ImageList
                  className="w-[9.5%] cursor-pointer p-1 rounded-md mr-2  border border-[rgba(0,0,0,0.12)]"
                  src="https://cdn.alibaba.ir/h2/desktop/assets/images/footer/samandehi-6e2b448a.png"
                ></ImageList>
                <ImageList
                  className="w-[10.5%] cursor-pointer p-1 rounded-md mr-2  border border-[rgba(0,0,0,0.12)]"
                ...
                ></ImageList>
                <ImageList
                  className="w-[11.5%] cursor-pointer p-1 rounded-md mr-2  border border-[rgba(0,0,0,0.12)]"
